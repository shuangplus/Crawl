# -*- coding: utf-8 -*-
# get from http://blog.csdn.net/zhangzhenhu/article/details/7014271
import struct
import sys
import binascii
import pdb
...
if __name__ == '__main__':
    ...
    for count,py,word in GTable:
        ...
        f.write( unicode('{%(count)s}' %{'count':count}+py+' '+ word).encode('GB2312') )#最终保存文件的编码，可以自给改
        f.write('\n')
    f.close()
